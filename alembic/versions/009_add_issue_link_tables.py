...
def upgrade():
    ...
    op.create_index(
        "ix_issue_milestone_links_issue_id", "issue_milestone_links", ["issue_id"]
    )
    op.create_index(
        "ix_issue_milestone_links_milestone_id",
        "issue_milestone_links",
        ["milestone_id"],
    )
    ...
    op.create_index(
        "ix_issue_project_links_issue_id", "issue_project_links", ["issue_id"]
    )
    op.create_index(
        "ix_issue_project_links_project_id", "issue_project_links", ["project_id"]
    )
...
def downgrade():
    ...
    op.drop_index(
        "ix_issue_milestone_links_milestone_id", table_name="issue_milestone_links"
    )
    op.drop_index(
        "ix_issue_milestone_links_issue_id", table_name="issue_milestone_links"
    )
