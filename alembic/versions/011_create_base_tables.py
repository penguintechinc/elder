...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "sync_users", sa.Boolean(), nullable=False, server_default=sa.text("true")
        ),
        sa.Column(
            "sync_groups", sa.Boolean(), nullable=False, server_default=sa.text("true")
        ),
    ...
    op.create_table(
        ...
        ),  # FK set after organizations table
    ...
    op.create_table(
        ...
        sa.Column(
            "group_id",
            sa.Integer(),
            sa.ForeignKey("identity_groups.id", ondelete="CASCADE"),
            nullable=False,
        ),
        sa.Column("role", sa.String(64), nullable=True),
        sa.Column(
    ...
    op.create_table(
        ...
        sa.Column(
            "request_id",
            sa.Integer(),
            sa.ForeignKey("group_access_requests.id", ondelete="CASCADE"),
            nullable=False,
        ),
        sa.Column(
            "approver_id",
    ...
    op.create_table(
        ...
        sa.Column(
            "membership_id",
            sa.Integer(),
            sa.ForeignKey("identity_group_memberships.id", ondelete="CASCADE"),
            nullable=True,
        ),
        sa.Column(
            "identity_id",
    ...
    op.create_table(
        ...
        sa.Column(
            "discovery_job_id",
            sa.Integer(),
            sa.ForeignKey("discovery_jobs.id", ondelete="CASCADE"),
            nullable=False,
        ),
        sa.Column("status", sa.String(64), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column(
            "parent_id",
            sa.Integer(),
            sa.ForeignKey("networking_resources.id", ondelete="CASCADE"),
            nullable=True,
        ),
        sa.Column("name", sa.String(255), nullable=True),
        sa.Column("type", sa.String(64), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "sync_mapping_id",
            sa.Integer(),
            sa.ForeignKey("sync_mappings.id", ondelete="CASCADE"),
            nullable=False,
        ),
        sa.Column(
            "resolved_by_id",
    ...
    op.create_table(
        ...
        sa.Column(
            "secret_provider_id",
            sa.Integer(),
            sa.ForeignKey("secret_providers.id", ondelete="CASCADE"),
            nullable=True,
        ),
        sa.Column(
            "organization_id",
    ...
    op.create_table(
        ...
        sa.Column(
            "key_provider_id",
            sa.Integer(),
            sa.ForeignKey("key_providers.id", ondelete="CASCADE"),
            nullable=True,
        ),
        sa.Column(
            "organization_id",
    ...
    op.create_table(
        ...
        sa.Column(
            "crypto_key_id",
            sa.Integer(),
            sa.ForeignKey("crypto_keys.id", ondelete="CASCADE"),
            nullable=False,
        ),
        sa.Column(
            "identity_id",
    ...
    op.create_table(
        ...
        sa.Column(
            "parent_id",
            sa.Integer(),
            sa.ForeignKey("ipam_prefixes.id", ondelete="CASCADE"),
            nullable=True,
        ),
        ...
        sa.Column("tags", sa.JSON(), nullable=True),
        sa.Column(
            "is_pool", sa.Boolean(), nullable=False, server_default=sa.text("false")
        ),
        sa.Column(
            "created_at",
            sa.DateTime(timezone=True),
    ...
    op.create_table(
        ...
        sa.Column(
            "parent_id",
            sa.Integer(),
            sa.ForeignKey("ipam_addresses.id", ondelete="CASCADE"),
            nullable=True,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "builtin_secret_id",
            sa.Integer(),
            sa.ForeignKey("builtin_secrets.id", ondelete="CASCADE"),
            nullable=True,
        ),
        sa.Column("name", sa.String(255), nullable=False),
        ...
        sa.Column("status", sa.String(64), nullable=True),
        sa.Column(
            "is_ca", sa.Boolean(), nullable=False, server_default=sa.text("false")
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "data_store_id",
            sa.Integer(),
            sa.ForeignKey("data_stores.id", ondelete="CASCADE"),
            nullable=False,
        ),
        sa.Column(
            "label_id",
    ...
    op.create_table(
        ...
        sa.Column(
            "component_id",
            sa.Integer(),
            sa.ForeignKey("sbom_components.id", ondelete="CASCADE"),
            nullable=False,
        ),
        sa.Column(
            "vulnerability_id",
    ...
    op.create_table(
        ...
        sa.Column(
            "resource_cost_id",
            sa.Integer(),
            sa.ForeignKey("resource_costs.id", ondelete="CASCADE"),
            nullable=False,
        ),
