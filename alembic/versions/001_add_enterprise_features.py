...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "resource_type",
            sa.Enum("ENTITY", "ORGANIZATION", name="resourcetype"),
            nullable=False,
        ...
        sa.Column(
            "role_type",
            sa.Enum("MAINTAINER", "OPERATOR", "VIEWER", name="resourceroletype"),
            nullable=False,
        ...
        sa.ForeignKeyConstraint(
            ["granted_by_id"], ["identities.id"], ondelete="SET NULL"
        ),
    ...
    op.create_index(
        op.f("ix_resource_roles_identity_id"),
        "resource_roles",
        ["identity_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_resource_roles_resource_type"),
        "resource_roles",
        ["resource_type"],
        unique=False,
    )
    op.create_index(
        op.f("ix_resource_roles_resource_id"),
        "resource_roles",
        ["resource_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "title", sa.String(length=255), nullable=False, comment="Issue title"
        ),
        sa.Column(
            "description",
            sa.Text(),
        ...
        sa.Column(
            "status",
            sa.Enum("OPEN", "IN_PROGRESS", "CLOSED", "RESOLVED", name="issuestatus"),
            nullable=False,
        ...
        sa.ForeignKeyConstraint(
            ["assigned_to_id"], ["identities.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(
            ["closed_by_id"], ["identities.id"], ondelete="SET NULL"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        op.f("ix_issues_resource_type"), "issues", ["resource_type"], unique=False
    )
    op.create_index(
        op.f("ix_issues_resource_id"), "issues", ["resource_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_issues_created_by_id"), "issues", ["created_by_id"], unique=False
    )
    op.create_index(
        op.f("ix_issues_assigned_to_id"), "issues", ["assigned_to_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_issue_comments_author_id"),
        "issue_comments",
        ["author_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "link_type",
            sa.Enum("RELATED", "BLOCKS", "BLOCKED_BY", "FIXES", name="issuelinktype"),
            nullable=False,
    ...
    op.create_index(
        op.f("ix_issue_entity_links_issue_id"),
        "issue_entity_links",
        ["issue_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_issue_entity_links_entity_id"),
        "issue_entity_links",
        ["entity_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "field_type",
            sa.Enum(
                "STRING", "NUMBER", "DATE", "BOOLEAN", "JSON", name="metadatafieldtype"
            ),
            nullable=False,
            comment="Data type of this field",
        ),
        sa.Column(
            "field_value", sa.Text(), nullable=False, comment="JSON-encoded field value"
        ),
        sa.Column(
            "is_system",
            sa.Boolean(),
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "resource_type", "resource_id", "field_key", name="uix_metadata_field"
        ),
    )
    op.create_index(
        op.f("ix_metadata_fields_resource_type"),
        "metadata_fields",
        ["resource_type"],
        unique=False,
    )
    op.create_index(
        op.f("ix_metadata_fields_resource_id"),
        "metadata_fields",
        ["resource_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_metadata_fields_field_key"),
        "metadata_fields",
        ["field_key"],
        unique=False,
    )
    op.create_index(
        op.f("ix_metadata_fields_created_by_id"),
        "metadata_fields",
        ["created_by_id"],
        unique=False,
    )
