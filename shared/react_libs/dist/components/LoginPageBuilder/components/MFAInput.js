 ...
 */
export const MFAInput = ({ length = 6, value, onChange, onComplete, disabled = false, error = false, colors, }) => {
    ...
    const handleChange = useCallback((index, digitValue) => {
        // Only allow digits
    ...
    return (_jsx("div", { className: "flex justify-center gap-2 sm:gap-3", children: digits.map((digit, index) => (_jsx("input", { ref: (el) => {
                inputRefs.current[index] = el;
            }, type: "text", inputMode: "numeric", pattern: "[0-9]*", maxLength: 1, value: digit, onChange: (e) => handleChange(index, e.target.value), onKeyDown: (e) => handleKeyDown(index, e), onPaste: handlePaste, onFocus: handleFocus, disabled: disabled, "aria-label": `Digit ${index + 1} of ${length}`, className: `
...
//# sourceMappingURL=MFAInput.js.map