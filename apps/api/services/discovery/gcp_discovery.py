"""Deprecated location for the gcp_discovery discovery provider.

The implementation lives in ``apps.worker.discovery.gcp_discovery``. This module only
