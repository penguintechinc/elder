...
// Regression coverage for the cloud-discovery graph rendering fix: the Map
// page must request + default-select the 4 cloud resource types so
...
// jsdom doesn't provide — stub it so this test stays focused on Map's own
// filter state and query params.
